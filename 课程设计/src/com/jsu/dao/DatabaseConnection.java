...
public class DatabaseConnection{
    ...
    private static final String DBURL="jdbc:sqlserver://localhost:1433;DatabaseName=Java课程设计";
    private static final String DBUSER="CPHDL"; //SQLServer数据库连接用户名
    private static final String PASSWORD="CPH5513."; //SQLServer数据库连接密码
